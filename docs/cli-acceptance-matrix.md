...
| Trigger                                                                | Fixture                                                            | Expected outcome                                                                                  | Smoke script                |
|------------------------------------------------------------------------|---------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|-----------------------------|
| `ph skill create --body ... --json`                                    | Empty `~/.prompthub/skills`                                         | Export package created with stable id/slug/package path; subsequent exports/show/install can resolve it | `Smoke/skill-lifecycle.sh`  |
