                ...
                VStack(spacing: 28) {
                    ...
                    LazyVGrid(columns: [GridItem(.flexible(), spacing: 16), GridItem(.flexible(), spacing: 16)], spacing: 16) {
                        ...
                        OnboardingStepTile(
                            ...
                            description: "This is what makes PromptHub different. Connect your agent folders here, then install the `ph` CLI with `brew install leetaogoooo/prompthub/ph` to read the same exports, install skills, and run `ph doctor` from your terminal or CI.",
                            isDone: cliConnected,
