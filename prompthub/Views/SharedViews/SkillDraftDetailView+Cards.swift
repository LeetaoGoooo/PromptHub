...
extension SkillDraftDetailView {
    ...
    var instructionsCard: some View {
        card(title: "Instructions", subtitle: "These instructions are exported as the body of SKILL.md and installed into target agents.") {
            TextEditor(text: $instructionsText)
                ...
                .overlay { RoundedRectangle(cornerRadius: 10).stroke(borderColor.opacity(0.4), lineWidth: 1) }
    ...
    var markdownPreviewCard: some View {
        card(title: "SKILL.md Preview", subtitle: "This is the markdown that will be copied or installed.") {
            ...
            .padding(12).background(Color(NSColor.textBackgroundColor)).clipShape(RoundedRectangle(cornerRadius: 10))
            .overlay { RoundedRectangle(cornerRadius: 10).stroke(borderColor.opacity(0.4), lineWidth: 1) }
        }
    }
    ...
    func card<Content: View>(title: String, subtitle: String, @ViewBuilder content: () -> Content) -> some View {
        ...
        .overlay { RoundedRectangle(cornerRadius: 16).stroke(borderColor.opacity(0.4), lineWidth: 1) }
    }
}
